...
from examples.model import DehazeNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='/home/newdisk/chenjiyou/self-supervised/SSID_cjy_1.1/examples/data/OTS')
    parser.add_argument('--valid_taroot', type=str, default='./input')
